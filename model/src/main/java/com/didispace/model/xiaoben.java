...
@Import({ App.class, cookie.class, thymeleafModel.class, jdbcMysql.class,WebConfigurer.class, thymeleafModeljdbc.class, bean.class, BeanConfig.class, HttpRequest.class, socketConfig.class, webSocket.class, logConfig.class })
